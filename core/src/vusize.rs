...
// pub fn encode_usize_to_slice<T: PrimInt>(value: usize, length: usize, slice: &mut [T]) {
//     debug_assert!(
...
//         header_bytes[0] = T::from(max_size_header()).unwrap();
//         header_bytes[1..USIZE_SIZE_PLUS_ONE].copy_from_slice(&(T::from(value).unwrap().to_le()));
//     } else {
